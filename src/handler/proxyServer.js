        ...
        if (!hosts[req.headers.host]) {
            ...
            return res.end(`
                ...
                <head>
                    ...
                    <title>${req.headers.host === `172.104.247.18` ? `You found me (#_<-)` : `503 | ${req.headers.host}`}</title>
                </head>
                <body>
                        ...
                        <main>
                            ...
                            <div style="margin: 1rem">
                                ...
                                <content stlye="font-size: 1.8rem">
                                    ...
                                    If you don't know what you're doing at this point, please contact <a href="https://waya.one/go/luna?utm_source=proxy">Luna</a>.
                                </content>
                            </div>
                        </main>
                    </div>
